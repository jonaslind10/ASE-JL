...
\begin{itemize}
	\item Den tilførte effekt på \SI{62}{\watt} ved \SI{30}{\watt} afgivet i nominelt \SI{8}{\ohm}. 
\end{itemize}

\begin{equation}
P_{CC} = \dfrac{V_{CC}V_O}{\pi R_L} \approx \SI{31}{\watt}
\end{equation}

\begin{equation}
P_{TOT} = P_{CC}\cdot 2 \approx \SI{62}{\watt}
\end{equation}
...
\begin{itemize}
	\item Den termiske modstand kaldes for køleprofilets K-værdi og enheden er en stigning i temperatur per effekt \SIUnitSymbolCelsius /\si{\watt}.
...
\begin{equation}
R_{th\: hs} = \dfrac{T_j-T_{amb}}{P}-R_{th\:j-mb}
\end{equation}
...
\begin{itemize}
	\item Dens termiske modstand blev regnet med en online lommeregner til \SI{3.77}{\degreeCelsius\per\watt}.
	\begin{itemize}
		\item $W:\SI{75}{\milli\meter}, L:\SI{69}{\milli\meter}, H: \SI{10}{\milli\meter}$
		\item 10 \textit{finner}.
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item Effekttabet i serieregulatoren.
\end{itemize}
...
\begin{itemize}
	\item Forstærker forskellen mellem de to indgange, $U_P$ og $U_N$.
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.25\linewidth]{graphics/differentialtrin}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.5\linewidth]{graphics/currentmirror}
	\caption{Strømspejl.}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.4\linewidth]{graphics/differentialtrin_fors}
...
Transistorens strømforstærkning $\beta$ forstærker differentialtrinnets udgangsstrøm. Denne strøm bliver ledet gennem en modstand, $R_C$, som laver det om til en spænding. 

\begin{figure} [H]
	\centering
	\includegraphics[width=0.6\linewidth]{graphics/vas}
...
\paragraph{Offset-fejl}
\begin{itemize}
	\item Der løber en lille basis-strøm, som i praksis vil føre til en fejl i $I_2$.
	\item Ikke matchede transistorer.
\end{itemize}

\paragraph{Støj}
\begin{itemize}
	\item Haglstøj ($i_n$) fra transistorens PN-overgang.
	\item Termisk støj ($e_n$) fra modstande, fx $r_x$ i BJT.
\end{itemize}

\begin{figure} [H]
	\centering
	\includegraphics[width=0.4\linewidth]{graphics/noise}
	\caption{Støjmodellen for operationsforstærker.}
	\label{fig:noise}
\end{figure}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.6\linewidth]{graphics/I-U_karakteristik}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.7\linewidth]{graphics/PN_overgang}
...
\paragraph{DC modellen} for dioden har en DC modstandsværdi.
\begin{itemize}
	\item $R_D$ resulterer i et større målt spændingsfald, $U_D$, i lederetningen ved en given strøm $I_F$.
\end{itemize} 
...
\begin{itemize}
	\item Seriemodstanden $R_D$ skyldes ledningsevnen af halvlederens materiale. Modstanden $R_D$ er ikke en konstant værdi.
\end{itemize}

\begin{figure} [H]
	\centering
	\includegraphics[width=0.6\linewidth]{graphics/DC_diode}
...
\begin{figure} [H]
	\centering
	\includegraphics[width=0.6\linewidth]{graphics/ACdiode}
...
\paragraph{Shuntregulator} med en zenerdiode kan anvendes til at give en konstant spænding eller som beskyttelse af
en indgang der ikke kan tåle spændinger over en given værdi.
\begin{itemize}
	\item Zenerdioder anvendes med en modstand $R_F$ der begrænser strømmen i zenerdioden til $I_Z$.
\end{itemize}

\begin{figure} [H]
	\centering
	\includegraphics[width=0.3\linewidth]{graphics/shunt}
	\caption{Shuntregulator.}
	\label{fig:shunt}
\end{figure}
