...
\begin{itemize}
	...
	\item \Cref{fig:42} viser hvordan lydtryksniveauet ændres for forskellige frekvenser for at blive opfattet som samme lydstyrke som \SI{1}{\kilo\hertz} referencen ved 40 phon.
\end{itemize}
